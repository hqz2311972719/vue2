        ...
        <div class="py-container">
            ...
            <div class="details clearfix">
                ...
                <div class="goods-list">
                    <ul class="yui3-g">
                        <li v-for="item in $store.state.product.searchProductResult.goodsList" class="yui3-u-1-5">
                            <div class="list-wrap">
                                <div class="p-img">
                ...
                <div class="hot-list">
                    <ul class="yui3-g">
                        <li class="yui3-u-1-4">
                            <div class="list-wrap">
                                <div class="p-img">
                                    <img src="../../../public/images/search/like_01.png" />
                                </div>
                                <div class="attr">
                        ...
                        <li class="yui3-u-1-4">
                            <div class="list-wrap">
                                <div class="p-img">
                                    <img src="../../../public/images/search/like_03.png" />
                                </div>
                                <div class="attr">
                        ...
                        <li class="yui3-u-1-4">
                            <div class="list-wrap">
                                <div class="p-img">
                                    <img src="../../../public/images/search/like_04.png" />
                                </div>
                                <div class="attr">
                        ...
                        <li class="yui3-u-1-4">
                            <div class="list-wrap">
                                <div class="p-img">
                                    <img src="../../../public/images/search/like_02.png" />
                                </div>
                                <div class="attr">
                                    <em>Apple苹果iPhone 6s (A1699)</em>
                                </div>
