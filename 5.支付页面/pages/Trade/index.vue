<template>
  <div>
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        <ul class="list clearFix" v-for="(order,index) in orderInfo.detailArrayList" :key="order.skuId">
          <li>
            <img :src="order.imgUrl" alt="" width="100px" height="80px">
          </li>
          <li>
            <p>
              {{order.skuName}}</p>
    ...
    <div class="sub clearFix">
      <router-link href="##"  to="/pay" class="subBtn" @click="this.$store.dispatch('postSubmitOrderAsync')">提交订单</router-link>
...
import  {getUserAddress} from "@/store/trade"
