    ...
    <div class="pay-main">
        <div class="pay-container">
            ...
            <div class="checkout-steps">
                ...
                <div class="submit">
                    <a class="btn" @click.prevent="payHandler" href="paysuccess.html" target="_blank">立即支付</a>
                </div>
                <div class="otherpay">
                    <div class="step-tit">
                        <h5>其他支付方式</h5>
...
<script>
//导入api
import {getCreateNative, getQueryPayStatus} from "@/api/payment";
...
export default {
  ...
  methods:{
   ...
   async payHandler(){
      ...
      this.$alert(`<img width="200" src="${base64Url}"/>`,'用微信扫描下方完成支付！',{
    ...
    mounted(){
        // 通过调用接口，获取返回来的响应头数据，this.$route.params.orderId是获取传过来的orderId数据
